module.exports = function(classObj) {
  ...
  if(schoolCode == "A00043-K4" || schoolCode == "A00059-K7") {
    ...
    // 한아름 6,7월 (1권), 연세유치원(20년 10월 2권), 한별유치원(7월 2권) 
  if(schoolCode == "A00088-K6" || schoolCode == "A00088-K5" || schoolCode == "A00059-K6") {
    book = [3, 4];
  }
  // 신촌시립어린이집2020(20년 10월 1권), 리틀즈월드(10월 21일 1권), 참조은 유치원(20년도)
  if(schoolCode == "C00353-K2" || schoolCode == "A00088-K8" || schoolCode == "C00194-K6") {
    book = [2, 3];
  }
    // 은솔어린이집(11월 1권)    
