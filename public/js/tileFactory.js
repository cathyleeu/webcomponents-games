...
TileFactory.prototype.create = function(tile, x, y) {
  ...
  if(info.img) {
    if(info.role == "character" && store.session.get('character')) {
      ...
      if(character.src.indexOf('cos_juice') >= 0) {
        animations = {
          stand_u: 9,
          walk_u: [9,10,9,11,9],
          stand_r: 3,
      ...
      if(character.src.indexOf('farm_cobot') >= 0) {
        animations = {
          stand_u: 9,
          walk_u: [9,10,9,11,9],
          stand_r: 3,
      ...
      if(character.src.indexOf('draw_b_cobot') >= 0) {
        animations = {
          stand_u: 9,
          walk_u: [9,10,9,11,9],
          stand_r: 3,
      ...
      if(character.src.indexOf('fisher_cobot') >= 0) {
        animations = {
          stand_u: 9,
          walk_u: [9,10,9,11,9],
          stand_r: 3,
      ...
      if(character.src.indexOf('winter_cobot') >= 0) {
        animations = {
          stand_u: 9,
          walk_u: [9,10,9,11,9],
          stand_r: 3,
